...
import com.ainrif.apiator.renderer.postman.PostmanRenderer
...
class PostmanRendererSmokeSpec extends Specification {
    static final String smokeJson = PostmanRendererSmokeSpec.classLoader.getResource('common-on-jaxrs-smoke.json').text
    ...
    ApiatorConfig getConfigWithJsonRenderer() {
        return new ApiatorConfig(
                ...
                apiHost: 'apiator.info',
                apiName: 'Apiator Smoke'
        )
    }

...
public interface JaxRsTypesParsingCheckService {
    ...
    void checkPlainBody(Dto01_Plain dto);

    @POST
    @Path("/post-body-complex")
    void checkComplexBody(Dto02_Complex dto);

    @POST
    @Path("/post-body-read-body-javabean")
    Dto03_JavaBean checkUpdate(Dto03_JavaBean dto);

    @POST
    @Path("/post-body-access_modifiers")
    void checkAccessModifiersDto(Dto04_AccessModifiers dto);

    @POST
    @Path("/post-body-type_value")
    Dto05_TypeValue checkTypeValue(Dto05_TypeValue<Integer> dto);

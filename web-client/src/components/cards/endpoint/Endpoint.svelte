...
<div class="target-marker" data-id={idForTargetMarkerOfEndpoint} />
<div
    class="card endpoint endpoint_type_{endpoint.method}"
    data-view-tab={activeTab}>
    <div on:click={handleTabClick} class="card__header">
        ...
        <span
            ...
            data-clipboard-text={linkToEndpoint}>
            Copy link
        </span>
        <span
                ...
                <table class="table table_endpoint">
                    ...
                    <tbody>
                        {#each params as param}
                            <tr class="param">
                                <td>
                                    {#if param.name}{param.name}{:else}-{/if}
                                    {#if param.required}
                                        <span class="param__required">
                                            (required)
                                        </span>
                                    {/if}
                                </td>

                                <td class="param__http-type">
                                    {param.httpParamType}
                                </td>
                                <td>
                                    {@html renderTemplate(param)}
                                </td>
                                <td>
    ...
    <div class="card__content card__content_tech">
        <div class="card__content-item card__content-endpoint-method">
            ...
            <div
                class="copy copy-btn"
                data-clipboard-text="{apiName}#{endpoint.name}">
                copy reference
            </div>
        </div>
